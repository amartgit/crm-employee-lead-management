            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-5">
                    <div class="my-5 card shadow-lg rounded-4 p-4">
                        <div class="card-body">
                            <h3 class="text-center fw-bold text-primary mb-2">Forgot Password</h3>
                            <p class="text-center text-muted">Enter your Employee ID and Mobile Number to reset your password.</p>
