...
<body>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-5">
                    <div class="my-5 card shadow-lg rounded-4 p-4">
                        <div class="card-body"
                        >
                            <h3 class="text-center fw-bold text-success">Reset Password</h3>
 ...
 @if(session('success'))
            ...
            <form method="POST" action="{{ route('password.updateuser') }}">
                @csrf
                <input type="text" name="employee_id" value="{{ $employee_id }}">

                <div class="mb-3">
                    <label for="password" class="form-label">New Password</label>
                    <input type="password" name="password" minlength="6" class="form-control" placeholder="Enter new password" required>
                    @error('password') 
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="password_confirmation" minlength="6" class="form-control" placeholder="Confirm new password" required>
